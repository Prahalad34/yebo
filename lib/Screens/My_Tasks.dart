...
class My_Tasks extends StatefulWidget {
  const My_Tasks({super.key});

  @override
  State<My_Tasks> createState() => _My_TasksState();
}

class _My_TasksState extends State<My_Tasks> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('My Tasks',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
